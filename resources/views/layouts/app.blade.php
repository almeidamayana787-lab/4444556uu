...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --footer-background:
                {{ $custom['footer_background'] }}
            ;
            --footer-text-color:
                {{ $custom['footer_text_color'] }}
            ;
            --footer-links:
                {{ $custom['footer_links'] }}
            ;
            --footer-button-background:
                {{ $custom['footer_button_background'] }}
            ;
            --footer-button-text:
                {{ $custom['footer_button_text'] }}
            ;
            --footer-button-border:
                {{ $custom['footer_button_border'] }}
            ;
            --footer-icons:
                {{ $custom['footer_icons'] }}
            ;
            --footer-titulos:
                {{ $custom['footer_titulos'] }}
            ;
            --footer-button-hover-language:
                {{ $custom['footer_button_hover_language'] }}
            ;
            --footer-button-color-language:
                {{ $custom['footer_button_color_language'] }}
            ;
            --footer-button-background-language:
                {{ $custom['footer_button_background_language'] }}
            ;
            --footer-button-border-language:
                {{ $custom['footer_button_border_language'] }}
            ;
            --footer-background-language:
                {{ $custom['footer_background_language'] }}
            ;
            ...
            --sidebar-background:
                {{ $custom['sidebar_background'] }}
            ;
            --sidebar-button-missoes-background:
                {{ $custom['sidebar_button_missoes_background'] }}
            ;
            --sidebar-button-vip-background:
                {{ $custom['sidebar_button_vip_background'] }}
            ;
            --sidebar-button-ganhe-background:
                {{ $custom['sidebar_button_ganhe_background'] }}
            ;
            --sidebar-button-bonus-background:
                {{ $custom['sidebar_button_bonus_background'] }}
            ;
            --sidebar-button-missoes-text:
                {{ $custom['sidebar_button_missoes_text'] }}
            ;
            --sidebar-button-ganhe-text:
                {{ $custom['sidebar_button_ganhe_text'] }}
            ;
            --sidebar-button-vip-text:
                {{ $custom['sidebar_button_vip_text'] }}
            ;
            --sidebar-button-hover:
                {{ $custom['sidebar_button_hover'] }}
            ;
            --sidebar-text-hover:
                {{ $custom['sidebar_text_hover'] }}
            ;
            --sidebar-text-color:
                {{ $custom['sidebar_text_color'] }}
            ;
            --sidebar-border:
                {{ $custom['sidebar_border'] }}
            ;
            --sidebar-icons:
                {{ $custom['sidebar_icons'] }}
            ;
            --sidebar_icons_background:
                {{ $custom['sidebar_icons_background'] }}
            ;
            ...
            --navbar-background:
                {{ $custom['navbar_background'] }}
            ;
            --navbar-text:
                {{ $custom['navbar_text'] }}
            ;
            --navbar-icon-menu:
                {{ $custom['navbar_icon_menu'] }}
            ;
            --navbar-icon-promocoes:
                {{ $custom['navbar_icon_promocoes'] }}
            ;
            --navbar-icon-casino:
                {{ $custom['navbar_icon_casino'] }}
            ;
            --navbar-icon-sport:
                {{ $custom['navbar_icon_sport'] }}
            ;
            --navbar-button-text-login:
                {{ $custom['navbar_button_text_login'] }}
            ;
            --navbar-button-text-registro:
                {{ $custom['navbar_button_text_registro'] }}
            ;
            --navbar-button-background-login:
                {{ $custom['navbar_button_background_login'] }}
            ;
            --navbar-button-background-registro:
                {{ $custom['navbar_button_background_registro'] }}
            ;
            --navbar-button-border-color:
                {{ $custom['navbar_button_border_color'] }}
            ;
            --navbar-button-text-superior:
                {{ $custom['navbar_button_text_superior'] }}
            ;
            --navbar-button-background-superior:
                {{ $custom['navbar_button_background_superior'] }}
            ;
            --navbar-text-superior:
                {{ $custom['navbar_text_superior'] }}
            ;
            --navbar_button_deposito_background:
                {{ $custom['navbar_button_deposito_background'] }}
            ;
            --navbar_button_deposito_text_color:
                {{ $custom['navbar_button_deposito_text_color'] }}
            ;
            --navbar_button_deposito_border_color:
                {{ $custom['navbar_button_deposito_border_color'] }}
            ;

            --navbar_button_deposito_píx_color_text:
                {{ $custom['navbar_button_deposito_píx_color_text'] }}
            ;
            --navbar_button_deposito_píx_background:
                {{ $custom['navbar_button_deposito_píx_background'] }}
            ;
            --navbar_button_deposito_píx_icon:
                {{ $custom['navbar_button_deposito_píx_icon'] }}
            ;

            --navbar_button_carteira_background:
                {{ $custom['navbar_button_carteira_background'] }}
            ;
            --navbar_button_carteira_text_color:
                {{ $custom['navbar_button_carteira_text_color'] }}
            ;
            --navbar_button_carteira_border_color:
                {{ $custom['navbar_button_carteira_border_color'] }}
            ;

            --navbar_perfil_text_color:
                {{ $custom['navbar_perfil_text_color'] }}
            ;
            --navbar_perfil_background:
                {{ $custom['navbar_perfil_background'] }}
            ;
            --navbar_perfil_icon_color:
                {{ $custom['navbar_perfil_icon_color'] }}
            ;

            --navbar_perfil_icon_color_border:
                {{ $custom['navbar_perfil_icon_color_border'] }}
            ;
            --navbar_perfil_modal_icon_color:
                {{ $custom['navbar_perfil_modal_icon_color'] }}
            ;
            --navbar_perfil_modal_text_modal:
                {{ $custom['navbar_perfil_modal_text_modal'] }}
            ;
            --navbar_perfil_modal_background_modal:
                {{ $custom['navbar_perfil_modal_background_modal'] }}
            ;
            --navbar_perfil_modal_hover_modal:
                {{ $custom['navbar_perfil_modal_hover_modal'] }}
            ;
            --navbar_icon_promocoes_segunda_cor:
                {{ $custom['navbar_icon_promocoes_segunda_cor'] }}
            ;
            ...
            --home_background_button_banner:
                {{ $custom['home_background_button_banner'] }}
            ;
            --home_icon_color_button_banner:
                {{ $custom['home_icon_color_button_banner'] }}
            ;
            --home_background_categorias:
                {{ $custom['home_background_categorias'] }}
            ;
            --home_text_color_categorias:
                {{ $custom['home_text_color_categorias'] }}
            ;


            --topo_icon_color:
                {{ $custom['topo_icon_color'] }}
            ;
            --topo_button_text_color:
                {{ $custom['topo_button_text_color'] }}
            ;
            --topo_button_background:
                {{ $custom['topo_button_background'] }}
            ;
            --topo_button_border_color:
                {{ $custom['topo_button_border_color'] }}
            ;

            --home_background_pesquisa:
                {{ $custom['home_background_pesquisa'] }}
            ;
            --home_text_color_pesquisa:
                {{ $custom['home_text_color_pesquisa'] }}
            ;
            --home_background_pesquisa_aviso:
                {{ $custom['home_background_pesquisa_aviso'] }}
            ;
            --home_text_color_pesquisa_aviso:
                {{ $custom['home_text_color_pesquisa_aviso'] }}
            ;
            --home_background_button_pesquisa:
                {{ $custom['home_background_button_pesquisa'] }}
            ;
            --home_icon_color_button_pesquisa:
                {{ $custom['home_icon_color_button_pesquisa'] }}
            ;


            --home_background_button_vertodos:
                {{ $custom['home_background_button_vertodos'] }}
            ;
            --home_text_color_button_vertodos:
                {{ $custom['home_text_color_button_vertodos'] }}
            ;
            --home_background_button_jogar:
                {{ $custom['home_background_button_jogar'] }}
            ;
            --home_text_color_button_jogar:
                {{ $custom['home_text_color_button_jogar'] }}
            ;
            --home_icon_color_button_jogar:
                {{ $custom['home_icon_color_button_jogar'] }}
            ;
            --home_hover_jogar:
                {{ $custom['home_hover_jogar'] }}
            ;
            --home_text_color:
                {{ $custom['home_text_color'] }}
            ;
            --home_background:
                {{ $custom['home_background'] }}
            ;

            --home_background_input_pesquisa:
                {{ $custom['home_background_input_pesquisa'] }}
            ;
            --home_icon_color_input_pesquisa:
                {{ $custom['home_icon_color_input_pesquisa'] }}
            ;
            --home_border_color_input_pesquisa:
                {{ $custom['home_border_color_input_pesquisa'] }}
            ;
            ...
            --gamelist_background:
                {{ $custom['gamelist_background'] }}
            ;
            --gamelist_input_background:
                {{ $custom['gamelist_input_background'] }}
            ;
            --gamelist_input_text_color:
                {{ $custom['gamelist_input_text_color'] }}
            ;
            --gamelist_input_border_color:
                {{ $custom['gamelist_input_border_color'] }}
            ;
            --gamelist_text_color:
                {{ $custom['gamelist_text_color'] }}
            ;
            --gamelist_button_background:
                {{ $custom['gamelist_button_background'] }}
            ;
            --gamelist_button_text_color:
                {{ $custom['gamelist_button_text_color'] }}
            ;
            --gamelist_button_border_color:
                {{ $custom['gamelist_button_border_color'] }}
            ;
            ...
            ;
            --register_text_color:
                {{ $custom['register_text_color'] }}
            ;
            --register_links_color:
                {{ $custom['register_links_color'] }}
            ;
            --register_input_background:
                {{ $custom['register_input_background'] }}
            ;
            --register_input_text_color:
                {{ $custom['register_input_text_color'] }}
            ;
            --register_input_border_color:
                {{ $custom['register_input_border_color'] }}
            ;
            --register_button_text_color:
                {{ $custom['register_button_text_color'] }}
            ;
            --register_button_background:
                {{ $custom['register_button_background'] }}
            ;
            --register_button_border_color:
                {{ $custom['register_button_border_color'] }}
            ;
            --geral_icons_color:
                {{ $custom['geral_icons_color'] }}
            ;
            --register_security_color:
                {{ $custom['register_security_color'] }}
            ;
            --register_security_background:
                {{ $custom['register_security_background'] }}
            ;
            --register_security_border-color:
                {{ $custom['register_security_border_color'] }}
            ;


            --login_background:
                {{ $custom['login_background'] }}
            ;
            --login_text_color:
                {{ $custom['login_text_color'] }}
            ;
            --login_links_color:
                {{ $custom['login_links_color'] }}
            ;
            --login_input_background:
                {{ $custom['login_input_background'] }}
            ;
            --login_input_text_color:
                {{ $custom['login_input_text_color'] }}
            ;
            --login_input_border_color:
                {{ $custom['login_input_border_color'] }}
            ;
            --login_button_text_color:
                {{ $custom['login_button_text_color'] }}
            ;
            --login_button_background:
                {{ $custom['login_button_background'] }}
            ;
            --login_button_border_color:
                {{ $custom['login_button_border_color'] }}
            ;

            --esqueci_background:
                {{ $custom['esqueci_background'] }}
            ;
            --esqueci_text_color:
                {{ $custom['esqueci_text_color'] }}
            ;
            --esqueci_input_background:
                {{ $custom['esqueci_input_background'] }}
            ;
            --esqueci_input_text_color:
                {{ $custom['esqueci_input_text_color'] }}
            ;
            --esqueci_input_border_color:
                {{ $custom['esqueci_input_border_color'] }}
            ;
            --esqueci_button_text_color:
                {{ $custom['esqueci_button_text_color'] }}
            ;
            --esqueci_button_background:
                {{ $custom['esqueci_button_background'] }}
            ;
            --esqueci_button_border_color:
                {{ $custom['esqueci_button_border_color'] }}
            ;
            ...
            --affiliates_background:
                {{ $custom['affiliates_background'] }}
            ;
            --affiliates_sub_background:
                {{ $custom['affiliates_sub_background'] }}
            ;
            --affiliates_text_color:
                {{ $custom['affiliates_text_color'] }}
            ;
            --affiliates_numero_color:
                {{ $custom['affiliates_numero_color'] }}
            ;
            --affiliates_button_saque_background:
                {{ $custom['affiliates_button_saque_background'] }}
            ;
            --affiliates_button_saque_text:
                {{ $custom['affiliates_button_saque_text'] }}
            ;
            --affiliates_button_copie_background:
                {{ $custom['affiliates_button_copie_background'] }}
            ;
            --affiliates_button_copie_text:
                {{ $custom['affiliates_button_copie_text'] }}
            ;
            --affiliates_icom_color:
                {{ $custom['affiliates_icom_color'] }}
            ;
            ...
            --carteira_button_background:
                {{ $custom['carteira_button_background'] }}
            ;
            --carteira_button_text_color:
                {{ $custom['carteira_button_text_color'] }}
            ;
            --carteira_button_border_color:
                {{ $custom['carteira_button_border_color'] }}
            ;
            --carteira_icon_color:
                {{ $custom['carteira_icon_color'] }}
            ;
            --carteira_text_color:
                {{ $custom['carteira_text_color'] }}
            ;
            --carteira_background:
                {{ $custom['carteira_background'] }}
            ;

            --carteira_saldo_background:
                {{ $custom['carteira_saldo_background'] }}
            ;
            --carteira_saldo_text_color:
                {{ $custom['carteira_saldo_text_color'] }}
            ;
            --carteira_saldo_border_color:
                {{ $custom['carteira_saldo_border_color'] }}
            ;
            --carteira_saldo_title_color:
                {{ $custom['carteira_saldo_title_color'] }}
            ;
            --carteira_saldo_icon_color:
                {{ $custom['carteira_saldo_icon_color'] }}
            ;
            --carteira_saldo_number_color:
                {{ $custom['carteira_saldo_number_color'] }}
            ;
            --carteira_saldo_button_deposito_background:
                {{ $custom['carteira_saldo_button_deposito_background'] }}
            ;
            --carteira_saldo_button_saque_background:
                {{ $custom['carteira_saldo_button_saque_background'] }}
            ;
            --carteira_saldo_button_deposito_text_color:
                {{ $custom['carteira_saldo_button_deposito_text_color'] }}
            ;
            --carteira_saldo_button_saque_text_color:
                {{ $custom['carteira_saldo_button_saque_text_color'] }}
            ;

            --carteira_deposito_background:
                {{ $custom['carteira_deposito_background'] }}
            ;
            --carteira_deposito_contagem_background:
                {{ $custom['carteira_deposito_contagem_background'] }}
            ;
            --carteira_deposito_contagem_text_color:
                {{ $custom['carteira_deposito_contagem_text_color'] }}
            ;
            --carteira_deposito_contagem_number_color:
                {{ $custom['carteira_deposito_contagem_number_color'] }}
            ;
            --carteira_deposito_contagem_quadrado_background:
                {{ $custom['carteira_deposito_contagem_quadrado_background'] }}
            ;
            --carteira_deposito_input_background:
                {{ $custom['carteira_deposito_input_background'] }}
            ;
            --carteira_deposito_input_text_color:
                {{ $custom['carteira_deposito_input_text_color'] }}
            ;
            --carteira_deposito_input_number_color:
                {{ $custom['carteira_deposito_input_number_color'] }}
            ;
            --carteira_deposito_input_border_color:
                {{ $custom['carteira_deposito_input_border_color'] }}
            ;
            --carteira_deposito_title_color:
                {{ $custom['carteira_deposito_title_color'] }}
            ;
            --carteira_deposito_number_color:
                {{ $custom['carteira_deposito_number_color'] }}
            ;
            --carteira_deposito_number_background:
                {{ $custom['carteira_deposito_number_background'] }}
            ;
            --carteira_deposito_button_background:
                {{ $custom['carteira_deposito_button_background'] }}
            ;
            --carteira_deposito_button_text_color:
                {{ $custom['carteira_deposito_button_text_color'] }}
            ;

            --carteira_saldo_pix_text_color:
                {{ $custom['carteira_saldo_pix_text_color'] }}
            ;
            --carteira_saldo_pix_sub_text_color:
                {{ $custom['carteira_saldo_pix_sub_text_color'] }}
            ;
            --carteira_saldo_pix_button_background:
                {{ $custom['carteira_saldo_pix_button_background'] }}
            ;
            --carteira_saldo_pix_button_text_color:
                {{ $custom['carteira_saldo_pix_button_text_color'] }}
            ;
            --carteira_saldo_pix_input_background:
                {{ $custom['carteira_saldo_pix_input_background'] }}
            ;
            --carteira_saldo_pix_input_text_color:
                {{ $custom['carteira_saldo_pix_input_text_color'] }}
            ;
            --carteira_saldo_pix_border_color:
                {{ $custom['carteira_saldo_pix_border_color'] }}
            ;
            --carteira_saldo_pix_icon_color:
                {{ $custom['carteira_saldo_pix_icon_color'] }}
            ;
            --carteira_saldo_pix_background:
                {{ $custom['carteira_saldo_pix_background'] }}
            ;
            ...
            --carteira_saque_background:
                {{ $custom['carteira_saque_background'] }}
            ;
            --carteira_saque_text_color:
                {{ $custom['carteira_saque_text_color'] }}
            ;
            --carteira_saque_number_color:
                {{ $custom['carteira_saque_number_color'] }}
            ;
            --carteira_saque_input_background:
                {{ $custom['carteira_saque_input_background'] }}
            ;
            --carteira_saque_input_text_color:
                {{ $custom['carteira_saque_input_text_color'] }}
            ;
            --carteira_saque_input_border_color:
                {{ $custom['carteira_saque_input_border_color'] }}
            ;
            --carteira_saque_button_text_color:
                {{ $custom['carteira_saque_button_text_color'] }}
            ;
            --carteira_saque_button_background:
                {{ $custom['carteira_saque_button_background'] }}
            ;
            --carteira_saque_icon_color:
                {{ $custom['carteira_saque_icon_color'] }}
            ;

            --carteira_history_background:
                {{ $custom['carteira_history_background'] }}
            ;
            --carteira_history_title_color:
                {{ $custom['carteira_history_title_color'] }}
            ;
            --carteira_history_text_color:
                {{ $custom['carteira_history_text_color'] }}
            ;
            --carteira_history_number_color:
                {{ $custom['carteira_history_number_color'] }}
            ;
            --carteira_history_status_finalizado_color:
                {{ $custom['carteira_history_status_finalizado_color'] }}
            ;
            --carteira_history_status_finalizado_background:
                {{ $custom['carteira_history_status_finalizado_background'] }}
            ;
            --carteira_history_status_pedente_color:
                {{ $custom['carteira_history_status_pedente_color'] }}
            ;
            --carteira_history_status_pedente_background:
                {{ $custom['carteira_history_status_pedente_background'] }}
            ;
            --carteira_history_barra_color:
                {{ $custom['carteira_history_barra_color'] }}
            ;
            --carteira_history_barra_text_color:
                {{ $custom['carteira_history_barra_text_color'] }}
            ;
            --carteira_history_icon_color:
                {{ $custom['carteira_history_icon_color'] }}
            ;
            --carteira_history_barra_background:
                {{ $custom['carteira_history_barra_background'] }}
            ;
            ...
            --vips_background:
                {{ $custom['vips_background'] }}
            ;
            --vips_title_color:
                {{ $custom['vips_title_color'] }}
            ;
            --vips_text_color:
                {{ $custom['vips_text_color'] }}
            ;
            --vips_description_color:
                {{ $custom['vips_description_color'] }}
            ;
            --vips_button_background:
                {{ $custom['vips_button_background'] }}
            ;
            --vips_button_text_color:
                {{ $custom['vips_button_text_color'] }}
            ;
            --vips_progress_background:
                {{ $custom['vips_progress_background'] }}
            ;
            --vips_progress_text_color:
                {{ $custom['vips_progress_text_color'] }}
            ;
            --vips_progress_prenchimento_background:
                {{ $custom['vips_progress_prenchimento_background'] }}
            ;
            --vips_icons_text_color:
                {{ $custom['vips_icons_text_color'] }}
            ;
            --vips_icons_background:
                {{ $custom['vips_icons_background'] }}
            ;
            --vips_icons_sub_text_color:
                {{ $custom['vips_icons_sub_text_color'] }}
            ;
            --vips_background_profile_vip:
                {{ $custom['vips_background_profile_vip'] }}
            ;
            --vips_icon_mover_color:
                {{ $custom['vips_icon_mover_color'] }}
            ;
            --vip_atual_background:
                {{ $custom['vip_atual_background'] }}
            ;
            --vip_atual_text_color:
                {{ $custom['vip_atual_text_color'] }}
            ;
            --vip_proximo_background:
                {{ $custom['vip_proximo_background'] }}
            ;
            --vip_proximo_text_color:
                {{ $custom['vip_proximo_text_color'] }}
            ;
            ...
            --promocoes_background:
                {{ $custom['promocoes_background'] }}
            ;
            --promocoes_title_color:
                {{ $custom['promocoes_title_color'] }}
            ;
            --promocoes_text_color:
                {{ $custom['promocoes_text_color'] }}
            ;
            --promocoes_sub_background:
                {{ $custom['promocoes_sub_background'] }}
            ;
            --promocoes_button_background:
                {{ $custom['promocoes_button_background'] }}
            ;
            --promocoes_button_text_color:
                {{ $custom['promocoes_button_text_color'] }}
            ;
            --promocoes_pupup_background:
                {{ $custom['promocoes_pupup_background'] }}
            ;
            --promocoes_pupup_text_color:
                {{ $custom['promocoes_pupup_text_color'] }}
            ;
            --promocoes_icon_color:
                {{ $custom['promocoes_icon_color'] }}
            ;
            ...
            --missoes_background:
                {{ $custom['missoes_background'] }}
            ;
            --missoes_sub_background:
                {{ $custom['missoes_sub_background'] }}
            ;
            --missoes_text_color:
                {{ $custom['missoes_text_color'] }}
            ;
            --missoes_title_color:
                {{ $custom['missoes_title_color'] }}
            ;
            --missoes_bonus_background:
                {{ $custom['missoes_bonus_background'] }}
            ;
            --missoes_bonus_text_color:
                {{ $custom['missoes_bonus_text_color'] }}
            ;
            --missoes_button_background:
                {{ $custom['missoes_button_background'] }}
            ;
            --missoes_button_text_color:
                {{ $custom['missoes_button_text_color'] }}
            ;
            --missoes_barraprogresso_background:
                {{ $custom['missoes_barraprogresso_background'] }}
            ;
            --missoes_barraprogresso_prenchimento_background:
                {{ $custom['missoes_barraprogresso_prenchimento_background'] }}
            ;
            --missoes_barraprogresso_text_color:
                {{ $custom['missoes_barraprogresso_text_color'] }}
            ;
            ...
            --background_geral_text_color:
                {{ $custom['background_geral_text_color'] }}
            ;
            --carregando_background:
                {{ $custom['carregando_background'] }}
            ;
            --carregando_text_color:
                {{ $custom['carregando_text_color'] }}
            ;
            ...
            --popup_cookies_background:
                {{ $custom['popup_cookies_background'] }}
            ;
            --popup_cookies_text_color:
                {{ $custom['popup_cookies_text_color'] }}
            ;
            --popup_cookies_button_background:
                {{ $custom['popup_cookies_button_background'] }}
            ;
            --popup_cookies_button_text_color:
                {{ $custom['popup_cookies_button_text_color'] }}
            ;
            --popup_cookies_button_border_color:
                {{ $custom['popup_cookies_button_border_color'] }}
            ;
            ...
            --menu_cell_background:
                {{ $custom['menu_cell_background'] }}
            ;
            --menu_cell_text_color:
                {{ $custom['menu_cell_text_color'] }}
            ;
            ...
            --aviso_sport_background:
                {{ $custom['aviso_sport_background'] }}
            ;
            --aviso_sport_text_color:
                {{ $custom['aviso_sport_text_color'] }}
            ;
            --titulo_principal_termos:
                {{ $custom['titulo_principal_termos'] }}
            ;
            --titulo_segundario_termos:
                {{ $custom['titulo_segundario_termos'] }}
            ;
            --descriçao_segundario_termos:
                {{ $custom['descriçao_segundario_termos'] }}
            ;
            ...
            --myconta_background:
                {{ $custom['myconta_background'] }}
            ;
            --myconta_text_color:
                {{ $custom['myconta_text_color'] }}
            ;
            --myconta_button_background:
                {{ $custom['myconta_button_background'] }}
            ;
            --myconta_button_icon_color:
                {{ $custom['myconta_button_icon_color'] }}
            ;
            --myconta_sub_background:
                {{ $custom['myconta_sub_background'] }}
            ;
            ...
            --central_suporte_background:
                {{ $custom['central_suporte_background'] }}
            ;
            --central_suporte_sub_background:
                {{ $custom['central_suporte_sub_background'] }}
            ;
            --central_suporte_button_background_ao_vivo:
                {{ $custom['central_suporte_button_background_ao_vivo'] }}
            ;
            --central_suporte_button_texto_ao_vivo:
                {{ $custom['central_suporte_button_texto_ao_vivo'] }}
            ;
            --central_suporte_button_icon_ao_vivo:
                {{ $custom['central_suporte_button_icon_ao_vivo'] }}
            ;
            --central_suporte_button_background_denuncia:
                {{ $custom['central_suporte_button_background_denuncia'] }}
            ;
            --central_suporte_button_texto_denuncia:
                {{ $custom['central_suporte_button_texto_denuncia'] }}
            ;
            --central_suporte_button_icon_denuncia:
                {{ $custom['central_suporte_button_icon_denuncia'] }}
            ;
            --central_suporte_title_text_color:
                {{ $custom['central_suporte_title_text_color'] }}
            ;
            --central_suporte_icon_title_text_color:
                {{ $custom['central_suporte_icon_title_text_color'] }}
            ;
            --central_suporte_info_text_color:
                {{ $custom['central_suporte_info_text_color'] }}
            ;
            --central_suporte_info_icon_color:
                {{ $custom['central_suporte_info_icon_color'] }}
            ;
            --central_suporte_aviso_title_color:
                {{ $custom['central_suporte_aviso_title_color'] }}
            ;
            --central_suporte_aviso_text_color:
                {{ $custom['central_suporte_aviso_text_color'] }}
            ;
            --central_suporte_aviso_text_negrito_color:
                {{ $custom['central_suporte_aviso_text_negrito_color'] }}
            ;
            --central_suporte_aviso_icon_color:
                {{ $custom['central_suporte_aviso_icon_color'] }}
            ;

            /*///////////////////////////////////////////////////////////////// */
            --bonus_diario_texto:
                {{ $custom['bonus_diario_texto'] }}
            ;
            --bonus_diario_texto_icon:
                {{ $custom['bonus_diario_texto_icon'] }}
            ;
            --bonus_diario_texto_valor_bonus:
                {{ $custom['bonus_diario_texto_valor_bonus'] }}
            ;
            --bonus_diario_aviso:
                {{ $custom['bonus_diario_aviso'] }}
            ;
            --bonus_diario_botao_backgroud:
                {{ $custom['bonus_diario_botao_backgroud'] }}
            ;
            --bonus_diario_botao_texto_color:
                {{ $custom['bonus_diario_botao_texto_color'] }}
            ;
            --bonus_diario_regras_title:
                {{ $custom['bonus_diario_regras_title'] }}
            ;
            --bonus_diario_regras_titulo:
                {{ $custom['bonus_diario_regras_titulo'] }}
            ;
            --bonus_diario_bola_interna:
                {{ $custom['bonus_diario_bola_interna'] }}
            ;
            --bonus_diario_bola_fora_:
                {{ $custom['bonus_diario_bola_fora_'] }}
            ;
            --bonus_diario_bola_carregamento:
                {{ $custom['bonus_diario_bola_carregamento'] }}
            ;
            --bonus_diario_texto_bola:
                {{ $custom['bonus_diario_texto_bola'] }}
            ;
            --bonus_diario_background:
                {{ $custom['bonus_diario_background'] }}
            ;
            --bonus_diario_sub_background:
                {{ $custom['bonus_diario_sub_background'] }}
            ;
            ...
            --maiores-ganhos-sub-background:
                {{ $custom['maiores_ganhos_sub_ackgroud'] }}
            ;
            --maiores-ganhos-text-color:
                {{ $custom['maiores_ganhos_texto_color'] }}
            ;
            --maiores-ganhos-valor-color:
                {{ $custom['maiores_ganhos_valor_color'] }}
            ;
            ...
            --live-ganhos-sub-background:
                {{ $custom['live_ganhos_sub_backgroud'] }}
            ;
            --live-ganhos-text-color:
                {{ $custom['live_ganhos_texto_color'] }}
            ;
            --live-ganhos-apostas-color:
                {{ $custom['live_ganhos_apostas_color'] }}
            ;
            --live-ganhos-ganhos-color:
                {{ $custom['live_ganhos_ganhos_color'] }}
            ;
            --live-ganhos-border-color:
                {{ $custom['live_ganhos_border_color'] }}
            ;
            ...
            --rodadas-gratis-border-color:
                {{ $custom['rodadas_gratis_border_color'] }}
            ;
            --rodadas-gratis-titulo-color:
                {{ $custom['rodadas_gratis_titulo_color'] }}
            ;
            --rodadas-gratis-titulo-background:
                {{ $custom['rodadas_gratis_titulo_background'] }}
            ;
            --rodadas-gratis-botao-color:
                {{ $custom['rodadas_gratis_botao_color'] }}
            ;
            --rodadas-gratis-botao-background:
                {{ $custom['rodadas_gratis_botao_background'] }}
            ;
            --rodadas-gratis-border-color-tabelas:
                {{ $custom['rodadas_gratis_border_color_tabelas'] }}
            ;
            --rodadas-gratis-color-texto1:
                {{ $custom['rodadas_gratis_color_texto1'] }}
            ;
            ...
            --maior_de_18_sub_background:
                {{ $custom['maior_de_18_sub_background'] }}
            ;
            --maior_de_18_texto_color:
                {{ $custom['maior_de_18_texto_color'] }}
            ;
            --maior_de_18_botao_sim_background:
                {{ $custom['maior_de_18_botao_sim_background'] }}
            ;
            --maior_de_18_botao_sim_texto_color:
                {{ $custom['maior_de_18_botao_sim_texto_color'] }}
            ;
            --maior_de_18_botao_nao_background:
                {{ $custom['maior_de_18_botao_nao_background'] }}
            ;
            --maior_de_18_botao_nao_texto_color:
                {{ $custom['maior_de_18_botao_nao_texto_color'] }}
            ;

            /*///////////////////////////////////////////////////////////////// */
            --pesquisar_homepage_background:
                {{ $custom['pesquisar_homepage_background'] }}
            ;
            --pesquisar_homepage_texto_color:
                {{ $custom['pesquisar_homepage_texto_color'] }}
            ;
            --pesquisar_homepage_icon_color:
                {{ $custom['pesquisar_homepage_icon_color'] }}
            ;
            --pesquisar_homepage_button_background:
                {{ $custom['pesquisar_homepage_button_background'] }}
            ;
            --pesquisar_homepage_button_text_color:
                {{ $custom['pesquisar_homepage_button_text_color'] }}
            ;
            /*///////////////////////////////////////////////////////////////// */

            --baixar_app_background:
                {{ $custom['baixar_app_background'] }}
            ;
            --baixar_app_sub_background:
                {{ $custom['baixar_app_sub_background'] }}
            ;
            --baixar_app_texto_color:
                {{ $custom['baixar_app_texto_color'] }}
            ;
            --baixar_app_explicacao_background:
                {{ $custom['baixar_app_explicacao_background'] }}
            ;
            --baixar_app_botao_background:
                {{ $custom['baixar_app_botao_background'] }}
            ;
            --baixar_app_botao_texto_color:
                {{ $custom['baixar_app_botao_texto_color'] }}
            ;
