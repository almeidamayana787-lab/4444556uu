...
class LayoutCssCustom extends Page implements HasForms
{
    ...
    protected function css_do_baixar_app(): Section
    {
        return Section::make("Página Baixar App")
            ...
            ->label('Baixar App')
            ->schema([
                ColorPicker::make('baixar_app_background')->label('Cor de fundo')->required(),
                ColorPicker::make('baixar_app_sub_background')->label('Cor de fundo secundária')->required(),
                FileUpload::make('baixar_app_imagem')->label('Imagem do App')->image()->placeholder('Carregue uma imagem'),
                ColorPicker::make('baixar_app_texto_color')->label('Cor do texto')->required(),
                ColorPicker::make('baixar_app_explicacao_background')->label('Cor de fundo da explicação')->required(),
                ColorPicker::make('baixar_app_botao_background')->label('Cor de fundo do botão')->required(),
                ColorPicker::make('baixar_app_botao_texto_color')->label('Cor do texto do botão')->required(),
            ])->columns(3);
    }
    ...
    protected function css_do_pesquisar_homepage(): Section
    {
        return Section::make("Pesquisar Homepage")
            ...
            ->label('Pesquisar Homepage')
            ->schema([
                ColorPicker::make('pesquisar_homepage_background')->label('Cor de fundo da pesquisa')->required(),
                ColorPicker::make('pesquisar_homepage_texto_color')->label('Cor do texto da pesquisa')->required(),
                ColorPicker::make('pesquisar_homepage_icon_color')->label('Cor do ícone da pesquisa')->required(),
                ColorPicker::make('pesquisar_homepage_button_background')->label('Cor de fundo do botão de pesquisa')->required(),
                ColorPicker::make('pesquisar_homepage_button_text_color')->label('Cor do texto do botão de pesquisa')->required(),
            ])->columns(2);
    }
    ...
    protected function getSectiimagensmanegem(): Section
    {
        return Section::make('banner e imagens')
            ...
            ->schema([
                ...
                FileUpload::make('menucell_img_esportes')->label("Imagem  cell esportes")->placeholder('Carregue uma imagem')->image(),
    ...
    protected function css_dos_maiores_ganhos(): Section
    {
        ...
        Toggle::make('maiores_ganhos_status')
            ...
            ->default(false)
            ->reactive(),
                ColorPicker::make('maiores_ganhos_backgroud')->label('Cor de Fundo')->required(),
                ColorPicker::make('maiores_ganhos_sub_ackgroud')->label('Cor de Fundo Secundária')->required(),
                ColorPicker::make('maiores_ganhos_texto_color')->label('Cor do Texto')->required(),
                ColorPicker::make('maiores_ganhos_valor_color')->label('Cor do Valor')->required(),
                FileUpload::make('maiores_ganhos_img_icon')->label('Ícone dos Maiores Ganhos')->image()->placeholder('Carregue uma imagem'),
            ])->columns(3);
    }
        ...
        return Section::make("Lives Ganhos")
            ...
            ->schema([
                Toggle::make('live_ganhos_status')
                    ...
                    ->default(false)
                    ->reactive(),
                ColorPicker::make('live_ganhos_backgroud')->label('Cor de Fundo')->required(),
                ColorPicker::make('live_ganhos_sub_backgroud')->label('Cor de Fundo Secundária')->required(),
                ColorPicker::make('live_ganhos_texto_color')->label('Cor do Texto')->required(),
                ColorPicker::make('live_ganhos_apostas_color')->label('Cor das Apostas')->required(),
                ColorPicker::make('live_ganhos_ganhos_color')->label('Cor dos Ganhos')->required(),
                ColorPicker::make('live_ganhos_border_color')->label('Cor da Borda')->required(),
                ColorPicker::make('live_ganhos_box_shadow_color')->label('Cor da Sombra')->required(),
            ])->columns(3);
    }
        ...
        return Section::make("Pop-up de Rodadas Grátis")
            ...
            ->schema([
                Toggle::make('rodadas_gratis_status')
                    ->label('Ativar Pop-up de Rodadas Grátis')
                    ->onColor('success')
                    ->offColor('danger')
                    ->inline(false)
                    ->default(false)
                    ->reactive(),
                FileUpload::make('rodadas_gratis_imagem')->label('Imagem do Pop-up 1536 × 1024')->image()->placeholder('Carregue uma imagem'),
                ColorPicker::make('rodadas_gratis_background')->label('Cor de Fundo')->required(),
                ColorPicker::make('rodadas_gratis_border_color')->label('Cor da Borda')->required(),

                TextInput::make('rodadas_gratis_titulo_texto')->label('Título')->maxLength(90),
                ColorPicker::make('rodadas_gratis_titulo_color')->label('Cor do Título')->required(),
                ColorPicker::make('rodadas_gratis_titulo_background')->label('Cor de Fundo do Título')->required(),

                ColorPicker::make('rodadas_gratis_botao_color')->label('Cor do Texto do Botão')->required(),
                ColorPicker::make('rodadas_gratis_botao_background')->label('Cor de Fundo do Botão')->required(),

                ColorPicker::make('rodadas_gratis_border_color_tabelas')->label('Cor da Borda das Tabelas')->required(),
                ColorPicker::make('rodadas_gratis_color_texto1')->label('Cor do Texto 1')->required(),
                ColorPicker::make('rodadas_gratis_color_texto2')->label('Cor do Texto 2')->required(),

                TextInput::make('rodadas_gratis_tabela1_texto1')->label('Tabela 1 - Texto 1')->maxLength(90),
                TextInput::make('rodadas_gratis_tabela1_texto2')->label('Tabela 1 - Texto 2')->maxLength(90),

                TextInput::make('rodadas_gratis_tabela2_texto1')->label('Tabela 2 - Texto 1')->maxLength(90),
                TextInput::make('rodadas_gratis_tabela2_texto2')->label('Tabela 2 - Texto 2')->maxLength(90),

                TextInput::make('rodadas_gratis_tabela3_texto1')->label('Tabela 3 - Texto 1')->maxLength(90),
                TextInput::make('rodadas_gratis_tabela3_texto2')->label('Tabela 3 - Texto 2')->maxLength(90),
            ])->columns(3);
    }
        ...
        return Section::make("Pop-up Maior de 18")
            ...
            ->schema([
                Toggle::make('maior_de_18_status')
                    ->label('Ativar Pop-up Maior de 18')
                    ->onColor('success')
                    ->offColor('danger')
                    ->inline(false)
                    ->default(false)
                    ->reactive(),
                ColorPicker::make('maior_de_18_background')->label('Cor de fundo do Pop-up')->required(),
                ColorPicker::make('maior_de_18_sub_background')->label('Cor de fundo secundária')->required(),
                ColorPicker::make('maior_de_18_texto_color')->label('Cor do texto')->required(),
                ColorPicker::make('maior_de_18_botao_sim_background')->label('Cor de fundo do botão "Sim"')->required(),
                ColorPicker::make('maior_de_18_botao_sim_texto_color')->label('Cor do texto do botão "Sim"')->required(),
                ColorPicker::make('maior_de_18_botao_nao_background')->label('Cor de fundo do botão "Não"')->required(),
                ColorPicker::make('maior_de_18_botao_nao_texto_color')->label('Cor do texto do botão "Não"')->required(),
            ])->columns(2);
    }
