...
class CustomLayout extends Model
{
   ...
   //POPUP COKIES
    ...
    'maiores_ganhos_backgroud',
    'maiores_ganhos_sub_ackgroud',
    'maiores_ganhos_texto_color',
    'maiores_ganhos_valor_color',
    'maiores_ganhos_img_icon',

    // // // // // // // // // // // // // // // // // // // 
    # // LIVE GANHOS
    'live_ganhos_status',
    'live_ganhos_backgroud',
    'live_ganhos_sub_backgroud',
    'live_ganhos_texto_color',
    'live_ganhos_apostas_color',
    'live_ganhos_ganhos_color',
    'live_ganhos_border_color',
    'live_ganhos_box_shadow_color',
    ...
    'rodadas_gratis_background',
    'rodadas_gratis_border_color',
    'rodadas_gratis_titulo_texto',
    'rodadas_gratis_titulo_color',
    'rodadas_gratis_titulo_background',
    'rodadas_gratis_botao_color',
    'rodadas_gratis_botao_background',
    'rodadas_gratis_border_color_tabelas',
    'rodadas_gratis_color_texto1',
    'rodadas_gratis_color_texto2',
